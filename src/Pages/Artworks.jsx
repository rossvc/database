...
// const cards = [//organize by style     if needed to get data from front end to back end then uncomment.
//   {
//     ArtworkID: 'AW000001',
//     ArtistID: 'AR12345',
//     Title: 'Mona Lisa',
...
//     Style: 'Renaissance Masterpieces',
//     SuppliedBy: 'SUP001',
...
//       try {
//         const response = await axios.get('https://ross.fail:3001/artworks');
...
// //         <div>
// //           <Button onClick={() => setFilter('All')}>All</Button>
// //           <Button onClick={() => setFilter('Renaissance Era')}>Renaissance Masterpieces</Button>
// //           <Button onClick={() => setFilter('Eastern Asia')}>Eastern Asian Treasures</Button>
// //           <Button onClick={() => setFilter('Middle East')}>Middle Eastern Visions</Button>
// //           <Button onClick={() => setFilter('Upcoming')}>Upcoming Artworks</Button>
// //         </div>
// //       </Container>
