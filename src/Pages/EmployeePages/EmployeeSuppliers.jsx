...
import { addSupplier, getAllSuppliers, updateSupplier } from '../../backend/Suppliers.api';
...
export default function EmployeeSuppliers() {
    ...
    const onClickAddSupplier = async () => {
        ...
        if (SupplierAddName === 'NULL' || SupplierAddName === 'null' || SupplierAddName === "") {truth1 = null} else {truth1 = SupplierAddName}
        if (SupplierAddContact === 'NULL' || SupplierAddContact === 'null' || SupplierAddContact === "") {truth2 = null} else {truth2 = SupplierAddContact}
    ...
    const onClickUpdateSupplier = async () => {
        var truth1, truth2;
        var ID; if (SupplierUpdateID === "") { ID = null} else { ID = Number(SupplierUpdateID)}
      
        if (SupplierUpdateName === 'NULL' || SupplierUpdateName === 'null' || SupplierUpdateName === "") {truth1 = null} else {truth1 = SupplierUpdateName}
        if (SupplierUpdateContact === 'NULL' || SupplierUpdateContact === 'null' || SupplierUpdateContact === "") {truth2 = null} else {truth2 = SupplierUpdateContact}
        ...
        <main>
            <Box sx={{ display: "flex", flexDirection: "row", height: "100%", width: "100%" }}>
              ...
              />
                  ...
                  <br />
                  <Button onClick={onClickUpdateSupplier} variant="outlined" color="primary" sx={{ marginTop: 1, marginBottom: 2, maxWidth: '80px', maxHeight: '50px', minWidth: '80px', minHeight: '50px' }}>
                    Update
                  </Button>
                  {showAlert2 && (
