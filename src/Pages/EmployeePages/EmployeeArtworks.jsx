...
export default function EmployeeArtworks() {
  ...
  const onClickUpdateArtwork = async () => {
    ...
    if (
      AUpdateArtistID === "NULL" ||
      AUpdateArtistID === "null" ||
      AUpdateArtistID === ""
    ) {
      truth1 = null;
    } else {
      truth1 = AUpdateArtistID;
    }
    if (
      AUpdateTitle === "NULL" ||
      AUpdateTitle === "null" ||
    ...
    if (
      AUpdateLocation === "NULL" ||
      AUpdateLocation === "null" ||
      AUpdateLocation === ""
    ) {
      truth3 = null;
    } else {
      truth3 = AUpdateLocation;
    }
    if (
      AUpdateDescription === "NULL" ||
      AUpdateDescription === "null" ||
      AUpdateDescription === ""
    ) {
      truth4 = null;
    } else {
      truth4 = AUpdateDescription;
    }
    if (
      AUpdateMedium === "NULL" ||
      AUpdateMedium === "null" ||
      ...
      truth5 = AUpdateMedium;
    }
    if (
      AUpdateDimensions === "NULL" ||
      AUpdateDimensions === "null" ||
      AUpdateDimensions === ""
    ) {
      truth6 = null;
    } else {
      truth6 = AUpdateDimensions;
    }
    if (
      AUpdateStyle === "NULL" ||
      AUpdateStyle === "null" ||
    ...
    if (
      AUpdateSupplier === "NULL" ||
      AUpdateSupplier === "null" ||
      AUpdateSupplier === ""
    ) {
      truth8 = null;
    } else {
      truth8 = Number(AUpdateSupplier);
    }
    if (
      AUpdateDateAcquired === "NULL" ||
      AUpdateDateAcquired === "null" ||
      AUpdateDateAcquired === ""
    ) {
      truth9 = null;
    } else {
      truth9 = AUpdateDateAcquired;
    }
    if (
      AUpdateImageURL === "NULL" ||
      AUpdateImageURL === "null" ||
      AUpdateImageURL === ""
    ) {
      truth10 = null;
    } else {
      truth10 = AUpdateImageURL;
    }
