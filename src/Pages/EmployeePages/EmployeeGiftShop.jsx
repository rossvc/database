...
export default function EmployeeGiftShop() {
  ...
  const onClickAddGiftShopItem = async () => {
    ...
    if (
      ...
      truth3 = Number(itemAddGSStock);
    }
    if (
      itemAddGSImageURL === "NULL" ||
      itemAddGSImageURL === "null" ||
      itemAddGSImageURL === ""
    ) {
      truth4 = null;
    } else {
      truth4 = itemAddGSImageURL;
    }
    try {
      const newItem = {
        ItemName: truth1,
  ...
  const onClickUpdateGiftShopItem = async () => {
    ...
    if (itemUpdateGSID === "") {
      ...
      ID = Number(itemUpdateGSID);
    }

    if (
      itemUpdateGSName === "NULL" ||
      itemUpdateGSName === "null" ||
      itemUpdateGSName === ""
    ) {
      truth1 = null;
    } else {
      truth1 = itemUpdateGSName;
    }
    if (
      itemUpdateGSPrice === "NULL" ||
      itemUpdateGSPrice === "null" ||
      itemUpdateGSPrice === ""
    ) {
      truth2 = null;
    } else {
      truth2 = Number(itemUpdateGSPrice);
    }
    if (
      itemUpdateGSStock === "NULL" ||
      itemUpdateGSStock === "null" ||
      itemUpdateGSStock === ""
    ) {
      truth3 = null;
    } else {
      truth3 = Number(itemUpdateGSStock);
    }
    if (
      itemUpdateGSImageURL === "NULL" ||
      itemUpdateGSImageURL === "null" ||
      itemUpdateGSImageURL === ""
    ) {
      truth4 = null;
    } else {
      truth4 = itemUpdateGSImageURL;
    }
    try {
      const updatedItem = {
        ItemName: truth1,
      ...
      >
        ...
        >
          ...
          >
            ...
            <Button
              id="AddItemBtn"
              onClick={onClickAddGiftShopItem}
              variant="outlined"
              color="primary"
              sx={{
                marginTop: 1,
          ...
          >
            ...
            <br />
            <Button
              onClick={onClickUpdateGiftShopItem}
              variant="outlined"
              color="primary"
              sx={{
                marginTop: 1,
